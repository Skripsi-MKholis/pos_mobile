                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: myTextField(
                            ...
                            labelText: 'Nilai',
                            placeholder: type == 'Persentase (%)'
                                ? '10'
                                : '5000',
                            keyboardType: TextInputType.number,
                            prefix: type == 'Nominal (Rp)'
                                ? const Text('Rp ')
                                : null,
                            suffix: type == 'Persentase (%)'
                                ? const Text('%')
                                : null,
                          ),
                        ),
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              isActive
                                  ? 'Aktif - Promo ini akan muncul di pembayaran'
                                  : 'Non-aktif - Promo ini disembunyikan',
                              style: GoogleFonts.plusJakartaSans(
                                fontSize: 11,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            IconButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        ApplyDiscountPage(selectedDiscount: d),
                                  ),
                                );
                              },
                              icon: const Icon(
                            ...
                            IconButton(
                              onPressed: () =>
                                  _showDiscountForm(discount: d, index: index),
                              icon: const Icon(
                                TablerIcons.edit,
                                size: 18,
                                color: Colors.blue,
